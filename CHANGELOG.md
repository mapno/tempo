...
* [CHANGE] Add the ability to specify the replication factor of the data within a block in the block's meta [#3628](https://github.com/grafana/tempo/pull/3628) (@mapno)
